...
const Navbar = (props) => {
    ...
    return (
        <div className="h-28 border-b-2 border-gray-300 fixed z-40 bg-white w-full shadow-lg">
            {!isPortrait ?
            <a className="float-left"><img className="ml-5 lg:ml-20 w-10 lg:w-20 ml-2 mt-4" onClick={()=>history.push("/")} src={logo}/></a>:
            <a className="float-left"><img className="ml-5 lg:ml-20 w-8/12 lg:w-20 ml-2 mt-5" onClick={()=>history.push("/")} src={logo}/></a>}
            ...
            {isPortrait?<a className="float-right">
                <img src={icon} className="mr-3 w-10 lg:w-20 ml-2 mt-7" onClick={()=>setShow(true)}/>
            </a>:null}
            {!isPortrait?<div className="navbar mr-10 mt-8">
                ...
                <div class="dropdown">
                    <button className="dropbtn">M.Ibtidayah
                        <i className="fa fa-caret-down"></i>
                    </button>
                    <div className="dropdown-content">
                        <a onClick={()=>history.push("/mi")}>M.Ibtidayah</a>
            ...
            >
                <div className="">
                    ...
                    {props.auth ?<div className="w-full m-auto text-center mt-2 mb-2 cursor-pointer underline">
                    ...
                    <div className="w-full m-auto text-center mt-2 mb-2 cursor-pointer underline">
                        <a onClick={()=>history.push("/smpi")}>M.Ibtidayah</a>
                    </div>
                    <div className="w-full m-auto text-center mt-2 mb-2 cursor-pointer underline">
                        <a onClick={()=>history.push("/galery-kegiatan")}>Galery Kegiatan</a>
                    </div>
