            ...
            <footer className='pt-5'>
                <div className='w-10/12 grid grid-cols-2 gap-5 m-auto'>
                    <div className='text-right'>
                        ...
                        <div className='pt-5'/>
                        <p className='text-sm'>Yayasan Pendidikan Khairiyah Mansuriyah</p>
                        <p className='text-sm'>Jl Sawah Lio I / 30</p>
                        <p className='text-sm'>Jembatan Lima-Jakarta Barat</p>
                    </div>
                    <div className='text-left'>
                        <p className='font-bold text-3xl mt-9'>Kontak</p>
                        <div className='pt-5'/>
                        <p className='text-sm'>Telp: 021-6334126</p>
